...
SCENE LOCATION: scene_location is a critical field. Extract the most specific location stated in the transmission — road name, junction, town, postcode, landmark, or address. Format junctions with a slash: "A57 Worksop Road / Ryton Street, Worksop". Other examples: "A57 Snake Pass eastbound, junction with Ladybower Reservoir", "Junction 26 M62 westbound", "outside 14 Park Lane, Sheffield". Listen for location clues throughout the entire transmission — crews often state location early. NEVER return "Not specified", "on scene", "incident scene", "RTC scene", or any generic descriptor. NEVER leave scene_location as null or empty if ANY location information appears anywhere in the transmission. If genuinely no location is mentioned at all, set scene_location to null. Once a scene_location has been set for an incident, it must not be cleared or overwritten with a less specific value in follow-up transmissions unless the crew explicitly states a different location.
